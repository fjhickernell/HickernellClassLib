...
**Goal:** inference about a population mean $\mu$
...
**Confidence Interval**
$$
\barX \;\pm\; t_{1-\alpha/2,\;n-1}\;\frac{s}{\sqrt{n}}
$$

**Properties**
- Exact confidence interval
- Valid for any sample size $n$
- Sensitive to non-normality for small $n$
...
**Typical setting:** paired or matched data (before/after, twins, same subject measured twice)
...
- Assumes $D_1,\dots,D_n$ are IID **Normal**
- Exact for any $n$
- Most common paired-data CI

**CLT-based interval**

- Assumes $D_i$ are IID with finite variance
- Requires **large $n$**
