...
# Critical value line
ax.axvline(z, linestyle="--", linewidth=4)

# Upper tail shading
xtail = x[x >= z]
ytail = st.norm.pdf(xtail)
ax.fill_between(xtail, 0, ytail, alpha=0.3)
...
ax.plot([z, z], [0, -0.02], transform=ax.get_xaxis_transform(), color="black")
...
## Student’s $t$ Confidence Interval for *Normal* Data with Unknown Variance
