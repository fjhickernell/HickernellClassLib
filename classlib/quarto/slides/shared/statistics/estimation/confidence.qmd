...
These are [upper critical values]{.alert}, not $\alpha$-quantiles.
...
You draw $n$ IID samples of your product to test for failure.
What is your confidence interval for $p$, the probability that a product is satisfactory, if none of the samples fail?
...
- $P_L$ is *a random variable*, defined as a function of $T$
  - If true success probability $< P_L$, then observing $\ge T$ successes is very unlikely
